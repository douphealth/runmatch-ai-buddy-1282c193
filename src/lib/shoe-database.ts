...
export const shoeDatabase: Shoe[] = [
  ...
  // === MAY 2026 ADDITIONS — backed by latest GearUpToFit reviews ===
  {
    ...
    injuryFriendly: ['knee-pain', 'shin-splints'], amazonASIN: '',
  ...
  },
  {
    ...
    injuryFriendly: ['plantar-fasciitis', 'knee-pain', 'achilles'], amazonASIN: '',
  ...
  },
  {
    ...
    injuryFriendly: ['plantar-fasciitis', 'knee-pain', 'shin-splints'], amazonASIN: '',
    reviewURL: 'https://gearuptofit.com/review/best-running-shoes/',
    imageURL: '/images/shoes/placeholder.jpg',
  ...
  },
  {
    ...
    injuryFriendly: ['knee-pain'], amazonASIN: '',
    reviewURL: 'https://gearuptofit.com/review/best-running-shoes/',
    imageURL: '/images/shoes/placeholder.jpg',
  ...
  },
  {
    ...
    injuryFriendly: ['plantar-fasciitis', 'knee-pain'], amazonASIN: '',
    reviewURL: 'https://gearuptofit.com/review/best-running-shoes/',
    imageURL: '/images/shoes/placeholder.jpg',
  ...
  },
  {
    ...
    injuryFriendly: ['knee-pain', 'achilles'], amazonASIN: '',
    reviewURL: 'https://gearuptofit.com/review/best-running-shoes/',
    imageURL: '/images/shoes/placeholder.jpg',
 ...
 * Never falls back to Amazon search pages; callers should hide Amazon CTAs when null.
 */
export function getAmazonLink(asin: string | null | undefined, affiliateTag: string = 'papalex-20'): string | null {
...
export function getShoeAmazonLink(shoe: Pick<Shoe, 'amazonASIN'>, affiliateTag: string = 'papalex-20'): string | null {
  return getAmazonLink(shoe.amazonASIN, affiliateTag);
}
